...
function EditSheet({ child, onClose, onSave }) {
  ...
  return (
    <>
      {/* Backdrop */}
      <div onClick={onClose} style={{ position: 'fixed', inset: 0, background: 'rgba(11,23,20,0.4)', zIndex: 80 }} />
      ...
      <div style={{
        ...
        <HRow justify="space-between" align="center" style={{ marginBottom: 20 }}>
          ...
          <button onClick={onClose} style={{ background: 'none', border: 'none', cursor: 'pointer', color: T.ink400 }}>
            <CBIcon name="x" size={20} />
          </button>
        </HRow>
          ...
          <Card p={0}>
            <button onClick={() => navigate(`/child/${child.id}/growth`)}
              ...
              <HRow gap={12} align="center" style={{ padding: '14px 16px' }}>
                <CBIcon name="growth" size={18} style={{ color: T.brand }} />
            ...
            <button onClick={() => navigate(`/child/${child.id}/vaccinations`)}
              style={{ width: '100%', background: 'none', border: 'none', cursor: 'pointer', textAlign: 'left' }}>
              <HRow gap={12} align="center" style={{ padding: '14px 16px' }}>
                <CBIcon name="shield" size={18} style={{ color: T.brand }} />
            ...
            <button onClick={() => navigate(`/child/${child.id}/health`)}
              style={{ width: '100%', background: 'none', border: 'none', cursor: 'pointer', textAlign: 'left' }}>
              <HRow gap={12} align="center" style={{ padding: '14px 16px' }}>
                <CBIcon name="heart-pulse" size={18} style={{ color: T.brand }} />
